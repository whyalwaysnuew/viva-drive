<x-front-layout>
                ...
                @foreach ($items as $item)
                    <div class="card-popular">
                        ...
                        <div class="flex items-center gap-1">
                            ...
                            <!-- Rating -->
                            <p class="text-dark text-xs font-semibold flex items-center gap-[2px] ml-auto">
                                <img src="/svgs/ic-star.svg" alt="">
                                ({{ $item->star }}/5)
                            </p>

                            <p class="text-xs font-semibold flex items-center gap-[2px]">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people-fill text-gray-600" viewBox="0 0 16 16">
    ...
    <section class="container relative pt-[100px]">
        <div class="flex items-center flex-col md:flex-row flex-wrap justify-center gap-8 lg:gap-[120px]">
            <img src="/images/car-10.jpg" class="w-full rounded-[18px] lg:max-w-[536px]" alt="">
