                    ...
                    <div class="bg-white rounded py-10 px-7">
                        <div class=" flex flex-wrap mt-4 mb-6 -mx-3">
                            <div class="w-full">
                                ...
                                <input value="{{ old('name') }}" type="text" placeholder="e.g. Porsche" name="name" required id="grid-last-name" class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance focus:outline-none focus:bg-white focus:border-gray-500">
