    ...
    <div class="py-8">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div>
                ...
                <form action="{{ route('admin.items.update', $item->id) }}" class="w-full" method="POST" encitem="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="bg-white rounded py-10 px-7">
                        <div class=" flex flex-wrap mt-4 mb-6 -mx-3">
                            <div class="w-full">
                                ...
                                <input value="{{ old('name') ?? $item->name }}" item="text" placeholder="e.g. Porsche" name="name" required id="grid-last-name" class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance focus:outline-none focus:bg-white focus:border-gray-500">
                                <div class="mt-2 text-sm text-gray-500">
                                    Item name. e.g: Honda, McLaren, Audi, Maseratti. Max 255 characters.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class=" flex flex-wrap mt-4 mb-6">
                            <div class="w-full">
                                ...
                                <select id="countries" class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance focus:outline-none focus:bg-white focus:border-gray-500">
