                    ...
                    <div class="bg-white rounded py-10 px-7">
                        <div class=" flex flex-wrap mt-4 mb-6">
                            <div class="w-full">
                                ...
                                <input value="{{ old('name') }}" type="text" placeholder="e.g. Cayman" name="name" required id="grid-last-name" class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500">
                        ...
                        <div class=" flex flex-wrap mt-4 mb-6">
                            <div class="w-full">
                                ...
                                <select required name="brand_id" id="grid-last-brands" class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500">
                        ...
                        <div class=" flex flex-wrap mt-4 mb-6">
                            <div class="w-full">
                                ...
                                <select required name="type_id" id="grid-last-types" class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500">
                        ...
                        <div class=" flex flex-wrap mt-4 mb-6">
                            <div class="w-full">
                                ...
                                <input value="{{ old('features') }}" type="text" placeholder="e.g. Autodrive" name="features" id="grid-last-features" class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500">
                                <div class="mt-2 text-sm text-gray-500">
                        ...
                        <div class="grid grid-cols-3 gap-3 px-3 mt-4 mb-6 -mx-3">
                            <div class="w-full">
                                ...
                                <input value="{{ old('price') }}" type="number" placeholder="e.g. 15000000" name="price" required id="grid-last-price" class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500">
                                <div class="mt-2 text-sm text-gray-500">
                            ...
                            <div class="w-full">
                                ...
                                <input value="{{ old('star') }}" type="number" placeholder="e.g. 4" name="star" required id="grid-last-star" class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500" min="1" max="5" step=".01">
                                <div class="mt-2 text-sm text-gray-500">
                            ...
                            <div class="w-full">
                                ...
                                <input value="{{ old('review') }}" type="number" placeholder="e.g. 3" name="review" required id="grid-last-review" class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500">
                                <div class="mt-2 text-sm text-gray-500">
