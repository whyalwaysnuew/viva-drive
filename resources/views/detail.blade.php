                ...
                @foreach ($similarItems as $similarItem)
                    ...
                    <div class="card-popular">
                        <div>
                            ...
                            <p class="text-sm font-normal text-secondary">{{ $similarItem->type ? $similarItem->type->name : '' }}</p>
                            <a href="{{ route('front.detail', $similarItem->slug) }}" class="absolute inset-0"></a>
                        </div>
                        <img src="{{ $similarItem->thumbnail }}" class="rounded-[18px] min-w-[216px] w-full h-[150px]"
                            alt="">
                        <div class="flex item-center justify-between gap-1">
                            <!-- Price -->
                            <p class="text-sm font-normal text-secondary">
                                <span class="text-base font-bold text-primary">${{ $similarItem->price}}</span>/day
                            </p>
                            <!-- Rating -->
                            <p class="text-dark text-xs font-semibold flex item-center gap-[2px]">
                                ({{ $similarItem->star }}/5)
